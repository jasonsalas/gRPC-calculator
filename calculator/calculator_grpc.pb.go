...
type CalculatorClient interface {
	...
	Multiply(ctx context.Context, in *MultplyRequest, opts ...grpc.CallOption) (*MultiplyResponse, error)
...
func (c *calculatorClient) Multiply(ctx context.Context, in *MultplyRequest, opts ...grpc.CallOption) (*MultiplyResponse, error) {
...
func (c *calculatorClient) Divide(ctx context.Context, in *DivisionRequest, opts ...grpc.CallOption) (*DivisionResponse, error) {
...
type CalculatorServer interface {
	...
	Multiply(context.Context, *MultplyRequest) (*MultiplyResponse, error)
...
func (UnimplementedCalculatorServer) Multiply(context.Context, *MultplyRequest) (*MultiplyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Multiply not implemented")
}
func (UnimplementedCalculatorServer) Divide(context.Context, *DivisionRequest) (*DivisionResponse, error) {
...
func _Calculator_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Multiply(ctx, req.(*MultplyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calculator_Divide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Divide(ctx, req.(*DivisionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
